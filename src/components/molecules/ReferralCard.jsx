  ...
  return (
    ...
    <div className="text-center">
        ...
        <div className="mb-6">
            ...
            <h2 className="font-display font-bold text-3xl mb-1">${referralData.totalEarnings.toFixed(2)}
            </h2>
        ...
        <div className="bg-white/10 rounded-lg p-4 mb-4">
            ...
            <div className="flex items-center space-x-2">
                <div
                    className="bg-white/20 rounded px-3 py-2 text-sm font-mono flex-1 text-left truncate">
        ...
        {/* Recent Activity */}
        {referralData.recentActivity && referralData.recentActivity.length > 0 && <div className="bg-white/10 rounded-lg p-4">
            <h3 className="font-medium mb-3">{t("recentActivity")}</h3>
            <div className="space-y-2">
                {referralData.recentActivity.slice(0, 3).map(
                    (activity, index) => <div key={index} className="flex items-center justify-between text-sm">
                        <div className="flex items-center space-x-2">
        ...
        <div className="mt-6 pt-4 border-t border-white/20 text-left">
            ...
            <div className="space-y-2 text-sm text-white/80">
                <div className="flex items-start space-x-2">
                    <div
                        className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center text-xs mt-0.5">1</div>
                    <div className="flex items-start space-x-2">
                        <div
                            className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center text-xs mt-0.5">1</div>
                    ...
                    <div className="flex items-start space-x-2">
                        <div
                            className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center text-xs mt-0.5">2</div>
                        <span>They sign up and make their first purchase/sale</span>
                    </div>
                    <div className="flex items-start space-x-2">
                        <div
                            className="w-5 h-5 bg-white/20 rounded-full flex items-center justify-center text-xs mt-0.5">3</div>
